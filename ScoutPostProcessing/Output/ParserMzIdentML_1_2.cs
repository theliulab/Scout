...
{
    public class ParserMzIdentML_1_2 : Mapper
    {
        ...
        /// Constructor
        /// </summary>
        public ParserMzIdentML_1_2()
            : base(sw)
        {
            m_Type = Mapper.SourceType.mzIdentML120;
            MzidML = new mzidFile1_2();
            ...
            cv2.id = "XLMOD";
            cv2.uri = "https://raw.githubusercontent.com/HUPO-PSI/mzIdentML/master/cv/XLMOD.obo";
            cv2.fullName = "PSI cross-link modifications";
            cvList.Add(cv2);
        ...
        public bool SaveMzIdML(string fpath, XLFilteredResults _results)
        {
            ...
            #region ModMass
            //foreach (char rs in reactionSites)
            //{
            SearchModificationType modifXL = new SearchModificationType();
            modifXL.massDelta = (float)ScoutParams.CXLReagent.WholeMass;
            modifXL.fixedMod = false;
            modifXL.residues = reactionSites.ToString();
            CVParamType cvXL = new CVParamType();
            cvXL.accession = "MS:1002510";
            cvXL.cvRef = "PSI-MS";
            cvXL.name = "cross-link receiver";
            modifXL.cvParam = new CVParamType[1] { cvXL };
            modificationList.Add(modifXL);
            //}
            #endregion
            ...
            CVParamType cvThresholdType = new CVParamType();
            cvThresholdType.name = "no threshold";
            cvThresholdType.accession = "MS:1001494";
            cvThresholdType.cvRef = "PSI-MS";
            thresholdListType.Items = new CVParamType[1] { cvThresholdType };
            ...
            foreach (var _csm in OriginalScoredCSMs)
            {
                ...
                string peptide2 = _csm.BetaPSM.Peptide.AsString;
                ...
                cvXLIdentifiedAlpha.name = "cross-link spectrum identification item";

                UserParamType userParamIsIntraLink = new UserParamType();
                userParamIsIntraLink.name = "cross-link_chain";
                userParamIsIntraLink.value = "alpha";
                ...
                specMzIdMLItemTypeAlpha.Items = new AbstractParamType[3] { cvXLIdentifiedAlpha, cvXLIdentifiedScoreAlpha, userParamIsIntraLink };
                #endregion
                ...
                cvXLIdentifiedBeta.name = "cross-link spectrum identification item";
                ...
                UserParamType userParamIsInterLink = new UserParamType();
                userParamIsInterLink.name = "cross-link_chain";
                userParamIsInterLink.value = "beta";

                specMzIdMLItemTypeBeta.Items = new AbstractParamType[3] { cvXLIdentifiedBeta, cvXLIdentifiedScoreBeta, userParamIsInterLink };
                #endregion
            ...
            int value = 0)
        {
            ...
            if (isXL)
            {
                ...
                if (isAlphaPeptide)
                {
                    ...
                    cvParams_Mod_donor.name = "cross-link donor";
                    cvParams_Mod_donor.accession = "MS:1002509";
                    cvParams_Mod_donor.cvRef = "PSI-MS";
                    cvParams_Mod_donor.value = value.ToString();

                    modification.cvParam = new CVParamType[2] { cvParams_Mod_xlLink, cvParams_Mod_donor };
